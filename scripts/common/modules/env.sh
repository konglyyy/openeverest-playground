...
load_env() {
  ...
  export EVEREST_HELM_REPO_NAME="${EVEREST_HELM_REPO_NAME:-percona}"
  export EVEREST_HELM_REPO_URL="${EVEREST_HELM_REPO_URL:-https://percona.github.io/percona-helm-charts/}"
  export EVEREST_HELM_CHART="${EVEREST_HELM_CHART:-percona/everest}"
  export EVEREST_HELM_CHART_VERSION="${EVEREST_HELM_CHART_VERSION:-}"
  export EVEREST_DB_NAMESPACE_CHART="${EVEREST_DB_NAMESPACE_CHART:-percona/everest-db-namespace}"
